...
DOCUMENTATION = '''
---
module:  cf_app_usage_event
short_description:  Interact with the Cloud Foundry AppUsageEvent API
'''
...
from pycf.cloudfoundry import AppUsageEvent
