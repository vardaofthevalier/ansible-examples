...
DOCUMENTATION = '''
---
module:  cf_service_brokers
short_description:  Interact with the Cloud Foundry ServiceBrokers API
'''
...
from pycf.cloudfoundry import ServiceBrokers
